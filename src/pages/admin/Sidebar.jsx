  ...
  return (
    <div className="w-h-full flex flex-col items-center">
      ...
      <div className="w-h-full flex flex-col justify-between items-center my-10 ">
        ...
        <div className="w-full flex items-center justify-center gap-6 cursor-pointer text-dark-bgpry hover:text-dark-text hover:text-bold">
          <div className="">
            <Stack direction="row" spacing={2} >
              <Avatar sx={{ bgcolor: "white", color: "#0033A0", width:"60px",height:"60px",fontSize:"25px" }}>
