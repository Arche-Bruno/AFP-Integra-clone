    ...
    <div className="w-h-full bg-dark-bgWhite flex flex-col gap-8 md:gap-0 pb-8">
      <div className=" max-h-[550px] bg-dark-primary relative pb-16  ">
        <div className="flex flex-col items-center gap-4 mt-8">
          <span className="text-center text-6xl font-bold">Hola {formUser.name},</span>
      ...
      <div className="text-black  lg:mt-[400px] bg-dark-bgpry p-8 rounded-lg flex flex-col gap-6 ">
        <span className="text-[20px] font-bold mx-24">
          ¿Qué es la rentabilidad negativa?
        </span>
        <p className="text-[18px] mx-24">
      ...
      <div className="w-h-full text-black px-4 mt-16 px-16">
        <div className="flex flex-col gap-16">
          <span className="text-center font-bold text-4xl lg:text-[50px] ">Tu fondo se construye a largo plazo</span>
...
<span className="text-black text-self text-[16px]">
      ¿Quieres saber más? Conoce qué es el valor cuota y cómo se calcula tu fondo a partir de este valor,<span className="text-dark-text_primary font-bold cursor-pointer ">aquí</span> .
      </span>
</div>
