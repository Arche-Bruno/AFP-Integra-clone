...
const Layout_admin = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-dark-bgWhite grid grid-cols-1 grid-rows-9 xl:grid-cols-9 text-white">
      ...
      <div className="w-h-full overflow-y-auto overflow-y-auto bg-dark-bgWhite row-span-9 pt-[85px] xl:pl-[320px] xl:col-span-9 xl:row-span-9 ">
      ...
      {showNav ? (
  <div className={`w-full min-h-screen bg-slate-950 bg-opacity-80 fixed inset-0 mt-[85px]`} onClick={handleShow}></div>
) : (
  <></>
)}
